...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern void DMA_DMAXferCplt(DMA_HandleTypeDef *hdma);
/* USER CODE END 0 */
...
int main(void)
{
  ...
  /* definition and creation of irCameraTask */
  osThreadDef(irCameraTask, StartIRCameraTask, osPriorityHigh, 0, 128);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOG, DRV8837_SLEEP_Pin|SHUTTER_INTB_Pin|SHUTTER_INTA_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CAL_DATAVALID_Pin|TCAL_EN_Pin|SENSOR_RESET_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DRV8837_SLEEP_Pin SHUTTER_INTB_Pin SHUTTER_INTA_Pin */
  GPIO_InitStruct.Pin = DRV8837_SLEEP_Pin|SHUTTER_INTB_Pin|SHUTTER_INTA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : CAL_DATAVALID_Pin TCAL_EN_Pin SENSOR_RESET_Pin */
  GPIO_InitStruct.Pin = CAL_DATAVALID_Pin|TCAL_EN_Pin|SENSOR_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_StartIRCameraTask */
/**
* @brief Function implementing the irCameraTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartIRCameraTask */
